...
public class ExceptionHandler extends ResponseEntityExceptionHandler {
	...
	@org.springframework.web.bind.annotation.ExceptionHandler(ExceptionCpfExists.class)
	public ResponseEntity<?> cpfExistsError(ExceptionCpfExists e, WebRequest wr){
		
		Problem p = new Problem();
		p.setTitle("Erro ao processar a requisição.");
		p.setStatus(HttpStatus.CONFLICT.value());
		p.setDetail("Cpf já existe para outra pessoa. Verifique!");
